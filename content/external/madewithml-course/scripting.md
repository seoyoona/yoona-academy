...
**testing**: As we'll see in our [testing lesson](https://madewithml.com/courses/mlops/testing/), it's significantly easier to compose and run tests on scripts, as opposed to Jupyter notebooks. This is crucial for ensuring that we have quality code that works as expected.
...
Recall that for training a model, we wrote code in our notebook for setting [configurations](https://madewithml.com/courses/mlops/training/#configurations), [training](https://madewithml.com/courses/mlops/training/#training), etc. that was freeform in a code cell:
...
In the next lesson on [command-line interfaces (CLI)](https://madewithml.com/courses/mlops/cli/), we'll learn how to execute these main workloads in our scripts from the command line.
...
Now that we've set up our scripts, we can start executing them from the command line. In the next lesson, we'll learn how to do this with [command-line interfaces (CLI)](https://madewithml.com/courses/mlops/cli/).
